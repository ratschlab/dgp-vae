  ...
  for sens_eval_type in std no_std; do
    for lat_dim in 8 16 32; do
      for len in 5,3,10 25,12,4 50,25,4; do
        ...
        --num_epochs 1 --kernel cauchy --eval_dir /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/hirid_sensitivity_eval_std.npz \
        --visualize --save --c_path /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/hirid_std.npz \
