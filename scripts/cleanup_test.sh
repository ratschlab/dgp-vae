...
# dSprites
  bsub -o /cluster/home/bings/dgpvae/models/cleanup_test/dsprites_log_%J -g /gpvae_disent \
  ...
  --data_dir /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/dsprites/dsprites_gp_full_range4.npz \
...
# NORB
  bsub -o /cluster/home/bings/dgpvae/models/cleanup_test/norb_log_%J -g /gpvae_disent \
  -R "rusage[mem=150000,ngpus_excl_p=1]" -R "select[gpu_model0==GeForceGTX1080Ti]" \
...
# Cars3D
  bsub -o /cluster/home/bings/dgpvae/models/cleanup_test/cars_log_%J -g /gpvae_disent \
...
# Shapes3D
  bsub -o /cluster/home/bings/dgpvae/models/cleanup_test/shapes_log_%J -g /gpvae_disent \
  -R "rusage[mem=220000,ngpus_excl_p=1]" -R "select[gpu_model0==GeForceGTX1080Ti]" \
  python run_experiment.py --model_type dgp-vae --data_type shapes3d --time_len 5 --testing --batch_size 32 \
  --data_dir /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/shapes3d/shapes_part2.npz \
...
# HiRID
  bsub -o /cluster/home/bings/dgpvae/models/cleanup_test/hirid_log_%J -g /gpvae_disent \
  -R "rusage[mem=650000,ngpus_excl_p=1]" \
  ...
  --num_steps 100 --kernel cauchy --c_path /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/hirid_std.npz \
