...
for model_seed in 210126_n_1,22019 210126_n_2,3412 210126_n_3,13351 210126_n_4,2677 210126_n_5,6071 210126_n_6,10843 210126_n_7,16040 210126_n_8,8088 210126_n_9,22060 210126_n_10,29153; do
  IFS=',' read model seed <<< "${model_seed}"
  bsub -o /cluster/home/bings/dgpvae/models/hirid/comp/base/dim_8/len_25/scaled/n_scales_4/log_%J \
  -g /gpvae_eval -R "rusage[mem=5000]" python dsprites_dci.py \
  --assign_mat_path /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/assign_mats/assign_mat_2.npy \
  --c_path /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/hirid_std.npz \
  --model_name /cluster/home/bings/dgpvae/models/hirid/comp/base/dim_8/len_25/scaled/n_scales_4/"$model" \
...
bsub -g /gpvae_eval -R "rusage[mem=5000]" python dsprites_dci.py --assign_mat_path /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/assign_mats/assign_mat_2.npy --c_path /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/hirid_std.npz --model_name /cluster/home/bings/dgpvae/models/hirid/comp1/base/dim_8/len_25/scaled/n_scales_4/210126_n_1 --data_type_dci hirid --save_score --shuffle --dci_seed 22019
