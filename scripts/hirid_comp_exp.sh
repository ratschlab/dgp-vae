...
mkdir -p models/hirid/comp/base/dim_8/len_25/scaled/n_scales_4
...
#
      ...
      --seed "$seed" --banded_covar --latent_dim 8 --encoder_sizes=128,128 --kernel_scales 4\
      ...
      --data_type_dci hirid --shuffle --dci_seed "$seed"
#    done
#    bsub -o models/hirid/comp/ada/dim_"$lat_dim"/log_%J -g /gpvae_disent -W 75:00 -R "rusage[mem=65000,ngpus_excl_p=1]" \
#    python run_experiment.py --model_type ada-gp-vae \
#    --data_type hirid --time_len 1 --testing --batch_size 64 --exp_name n_"$n"_band_2 \
...
#    --window_size 1 --banded_covar --sigma 1.005 --beta 1.0 --num_steps 404683 --kernel id \
#    --c_path /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/hirid_std.npz \
...
#bsub -o models/hirid/comp/dev/log_%J -g /gpvae_norm -W 4:00 -R "rusage[mem=65000,ngpus_excl_p=1]" python run_experiment.py --model_type gp-vae --data_type hirid --time_len 25 --testing --batch_size 64 --exp_name n_10 --basedir models/hirid/comp/dev --len_init scaled --data_dir /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/hirid_std.npz --seed 2677 --banded_covar --latent_dim 8 --encoder_sizes=128,128 --kernel_scales 2 --decoder_sizes=256,256 --window_size 12 --sigma 1.005 --length_scale 20.0 --beta 1.0 --num_epochs 1 --kernel cauchy --c_path /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/hirid_std.npz --visualize_score --save_score --eval_type dci --data_type_dci hirid --shuffle --dci_seed 2677
#
#bsub -o models/hirid/comp/ada/dim_8/log_%J -g /gpvae_disent -W 65:00 -R "rusage[mem=65000,ngpus_excl_p=1]" python run_experiment.py --model_type ada-gp-vae --data_type hirid --time_len 1 --testing --batch_size 64 --exp_name n_3_noband --basedir models/hirid/comp/ada/dim_8 --len_init same --data_dir /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/hirid_std.npz --seed 13351 --latent_dim 8 --encoder_sizes=128,128 --decoder_sizes=256,256 --window_size 1 --banded_covar --sigma 1.005 --beta 1.0 --num_steps 404683 --kernel id --c_path /cluster/work/grlab/projects/projects2020_disentangled_gpvae/data/hirid/hirid_std.npz --visualize_score --save_score --eval_type dci --data_type_dci hirid --shuffle --dci_seed 13351