...
flags.DEFINE_enum('kernel', 'cauchy', ['rbf', 'diffusion', 'matern', 'periodic', 'cauchy', 'cauchy_const'], 'Kernel to be used for the GP prior: Ignored if model_type is not (m)gp-vae')
